...
This prints the result. Also create all one more method with name “calculateResult” with
...
5. With the result it’s also print one more message
...
public class Calculator {
    ...
    public void addition(int a ,int b){      //method for addition
        int result=a+b;
        System.out.println(result);
    }
    public void subtraction(int a,int b){    //method for subtraction
         int result=a-b;
        System.out.println(result);

    }
    public void division(int a,int b) {          //method for division
        int result=a/b;
        System.out.println(result);

    }
    public void multiplication(int a,int b){     //method for multiplication
        int result=a*b;
        System.out.println(result);

    }
    public void calculateResult(int a,int b,char symbol) {     //method for calculatiing result this will be called in main class.
