...
public class Zone1Station10 {
    public static void main(String[] args) {
        ...
        System.out.println("Enter the station you want to search from Given Name :  Aldgate,Liverpool St,Moorgate,Kings Cross," +
                "Euston,Bank,Old Street,Angel,Warren Street,Oxford Circus,Green Park");
